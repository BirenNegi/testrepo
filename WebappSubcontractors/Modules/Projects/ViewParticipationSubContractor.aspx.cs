        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    //#--21012019--To display Dtraft Contract Template
                    if (tradeParticipationInfo.Trade.Contract == null && tradeParticipationInfo.Trade.JobTypeName=="Construction")
                    { 
                        phDraftContract.Visible = true;
                        lnkDraftContract.NavigateUrl = "~/Modules/Contracts/ViewDraftContract.aspx?TradeId=" + tradeParticipationInfo.Trade.IdStr;
                    }//#--21012019--To display Dtraft Contract Template
