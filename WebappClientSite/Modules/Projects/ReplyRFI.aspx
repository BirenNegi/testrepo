<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Client.master" AutoEventWireup="true" CodeBehind="ReplyRFI.aspx.cs" Inherits="SOS.Web.ReplyRFI" %>
    ...
    <style type="text/css">
      ...
      <script type="text/jscript">
          ...
          function displayFile() {
              ...
              {
                  td.innerHTML = "<br /> <span style='text-decoration: underline'><Strong> Selected Files</Strong></span> <br />  ";
                  ...
                  if (FileSize > 500)
                  {
                      alert("File size is >500MB,Please use alternative way to send the files...");
                      td.innerHTML = "";
                      fileUpload.value="";
