  ...
  <a href="#">Contact</a>
	        ...
	        <table>
	            <tr>
                    ...
                    <td><%--<sos:FileLink ID="sflReferenceFile" runat="server" FileTitle="Reference File" />--%>
                        <asp:HyperLink ID="HlReferenceFile" runat="server" CssClass="HlRef" Visible="false">Reference File</asp:HyperLink>
	...
	<tr>
            <td style="vertical-align:top" Width="220px">
                <asp:GridView ID="GridView1" runat="server" ShowHeader="False" AutoGenerateColumns="False" Width="200px" OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                    <Columns>
                        <asp:TemplateField>
