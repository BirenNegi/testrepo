<%@ Page Language="C#" MasterPageFile="~/MasterPages/Client.master" AutoEventWireup="true" Inherits="SOS.Web.ViewHelpPage" Title="Help" Codebehind="Help.aspx.cs" %>
...
<act:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" EnablePartialRendering="true" EnableScriptGlobalization="true" EnableScriptLocalization="true" CombineScripts="false" />
    ...
    <h1> Please contact Contract Administrator</h1>
<%--<!-- Intro -->
<table>
    <tr>
