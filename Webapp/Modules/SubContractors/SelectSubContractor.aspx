<%@ Page Language="C#" AutoEventWireup="true" Inherits="SOS.Web.SelectSubContractorPage" Title="Subcontractors" Codebehind="SelectSubContractor.aspx.cs" %>
...
<body>
    ...
    <asp:ObjectDataSource 
        ...
        <SelectParameters>
           ...
           <%-- <asp:ControlParameter Name="ProjectId" ControlID="ProjectId" />--%>
        </SelectParameters>
    </asp:ObjectDataSource>
            ...
            <td>
                <table cellspacing="1" cellpadding="1">
                    <tr>
                        ...
                        <td><asp:TextBox ID="ProjectId" runat="server"></asp:TextBox></td>
                    </tr>
                </table>
            </td>
        </tr>
