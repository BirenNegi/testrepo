    ...
    <tr>
        <td class="frmForm">
            <table width="100%">
                ...
                <%-- San --%>
                <tr>
                    <td class="frmLabel">ACN:</td>
                    <td class="frmData"><asp:Label ID="lblACN" runat="server"></asp:Label></td>
                    <td>&nbsp;</td>
                    <td class="frmLabel">Licence Number:</td>
                    <td class="frmData"><asp:Label ID="lblLicenceNumber" runat="server"></asp:Label></td>
                </tr>
                <%-- San --%>
                <tr>
                ...
                <tr>
                    <td class="frmLabel">Public liability Insurance:</td>
                    <td class="frmData" colspan="4"><asp:Label ID="lblPublicliabilityInsurance" runat="server"></asp:Label></td>
                </tr> 
                <tr>
                    <td class="frmLabel">Workcover Insurance:</td>
                    <td class="frmData" colspan="4"><asp:Label ID="lblWorkCoverInsurance" runat="server"></asp:Label></td>
                </tr> 
                

                <tr>
                    <td class="frmLabel">D&amp;C Contractor ? </td>
                    <td class="frmData" colspan="4"> <asp:CheckBox ID="chkDC" runat="server"  Enabled="False" /></td>
                </tr>                

                <tr>
                    <td class="frmLabel">PI Insurance:</td>
                    <td class="frmData" colspan="4"><asp:Label ID="lblProfessionalIndemnity" runat="server"></asp:Label></td>
                </tr>  
                
                                <tr>
                    <td class="frmLabel" valign="top">Other Business Units</td>
                    <td colspan="4" class="frmData">
                      <asp:Label ID="lblBusinesUnitList" runat="server"></asp:Label>  
                    </td>
                </tr>
...
<table>
        ...
        <td>
            <asp:GridView
                ...
                <Columns>
                   ...
                   <%-- San --%>
                     <asp:BoundField DataField="Position" HeaderText="Position" HeaderStyle-CssClass="lstHeader" ItemStyle-Wrap="False" ItemStyle-VerticalAlign="Top"></asp:BoundField>
    ...
    <%-- San --%>
      <tr>
        <td class="lstTitle">&nbsp;&nbsp;</td>
    </tr>

      <tr>
        <td class="lstTitle">Employees</td>
    </tr>
    <tr>
        <td>
            <asp:GridView
