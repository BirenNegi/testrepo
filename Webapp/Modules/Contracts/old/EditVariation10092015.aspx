    ...
    <tr>
        <td class="frmForm">
            <table width="100%">
                ...
                <tr>
                    <td class="frmLabel">Allowance:</td>
                    <td>
                        <asp:CompareValidator ID="valAllowance" runat="server" CssClass="frmError" Display="Dynamic" ErrorMessage="Invalid number!<br />" ControlToValidate="txtAllowance" Operator="DataTypeCheck" Type="Currency"></asp:CompareValidator>
                        <asp:CustomValidator ID="valBOQAllowance" runat="server" OnServerValidate="valBOQAllowance_ServerValidate" CssClass="frmError" Display="Dynamic"></asp:CustomValidator>
                                    ...
                                    <asp:UpdatePanel ID="aupBudgetBalances" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <table cellpadding="4" cellspacing="1" runat="server" id="tblBudgetBalances">
                                                <tr>
                                                    <td class="lstHeader" align="center" colspan="2">Budget</td>
