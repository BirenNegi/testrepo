        ...
        <td class="frmForm">
            ...
            <%-- San --%>
                ...
                <%-- San --%>
                 ...
                 <%-- DS20231005 --%>
                  <tr>
                       <td class="frmLabel">Variations (CV, SA)  over amount UM authority:</td>
                        <td class="frmText">
                            <asp:CompareValidator ID="CompareValidator6" runat="server" CssClass="frmError" Operator="DataTypeCheck" Type="Currency" Display="Dynamic" ErrorMessage="Invalid number!<br />" ControlToValidate="txtVariationSepAccUMApproval"></asp:CompareValidator>
                            <asp:TextBox ID="txtVariationSepAccUMApproval" runat="server" Width="150"></asp:TextBox>
                        </td>
                    </tr>
                 <%-- DS20231005 --%>
                  <tr>
                       <td class="frmLabel">Variations (BOQ,V,CV,DV)  over amount UM authority:</td>
                        <td class="frmText">
                            <asp:CompareValidator ID="CompareValidator7" runat="server" CssClass="frmError" Operator="DataTypeCheck" Type="Currency" Display="Dynamic" ErrorMessage="Invalid number!<br />" ControlToValidate="txtVariationUMBOQVCVDVApproval"></asp:CompareValidator>
                            <asp:TextBox ID="txtVariationUMBOQVCVDVApproval" runat="server" Width="150"></asp:TextBox>
                        </td>
                    </tr>
