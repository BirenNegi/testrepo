...
<%-- San --%>
                <tr>
                    <td colspan="5">
                        <asp:GridView ID="GvDistributionList" runat="server" AutoGenerateColumns="False" DataKeyNames="PeopleId,TransmittalId,ProjectId"
                        ...
                        AlternatingRowStyle-CssClass = "lstAltItem">
                            <Columns>
                                <asp:BoundField DataField="PeopleId" HeaderText="PeopleId" InsertVisible="False" ReadOnly="True" SortExpression="PeopleId" HeaderStyle-CssClass="lstHeader" />
                                <asp:BoundField DataField="TransmittalId" HeaderText="TransmittalId" ReadOnly="True" SortExpression="TransmittalId" HeaderStyle-CssClass="lstHeader"  />
                                <asp:BoundField DataField="FirstName" HeaderText="FirstName" SortExpression="FirstName" HeaderStyle-CssClass="lstHeader"/>
                                <%--<asp:BoundField DataField="LastName" HeaderText="LastName" SortExpression="LastName" HeaderStyle-CssClass="lstHeader"/>--%>
                                ...
                                <%--
                                <asp:BoundField DataField="ProjectId" HeaderText="ProjectId" ReadOnly="True" SortExpression="ProjectId" HeaderStyle-CssClass="lstHeader"/>
                                <asp:BoundField DataField="SendTransmittals" HeaderText="SendTransmittals" ReadOnly="True" SortExpression="SendTransmittals" HeaderStyle-CssClass="lstHeader"/>
                               --%>
                                <asp:TemplateField HeaderStyle-CssClass="lstHeader">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="ChkSendTransmittals" runat="server"  Checked='<%# Convert.ToInt32(Eval("SendTransmittals"))==0?false:true %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>

                        <%-- <%# Eval("SendTransmittals")==null?false:true %> --%>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SOSTestConnectionString %>" 
                            SelectCommand="SELECT People.PeopleId, ClientAccess.ProjectId as TransmittalId, People.FirstName+' -'+People.LastName as FirstName, People.EmployeePosition,
                                            ...
                                            left outer JOIN TransmittalsClientContact ON People.PeopleId = TransmittalsClientContact.PeopleId and TransmittalsClientContact.TransmittalId=18770
                                            WHERE (ClientAccess.ProjectId='424')">
                        </asp:SqlDataSource>
