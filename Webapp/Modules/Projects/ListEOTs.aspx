<%@ Page Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" Inherits="SOS.Web.ListEOTsPage" Title="EOTs" Codebehind="ListEOTs.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">

<sos:TitleBar ID="TitleBar1" runat="server" Title="EOTs" />
            ...
            <asp:GridView
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderStyle-CssClass="lstHeader" ItemStyle-HorizontalAlign="Center" HeaderText="EOT">
                        <ItemTemplate>
                            <%--#--Passed editional parameter &NODID="+null
