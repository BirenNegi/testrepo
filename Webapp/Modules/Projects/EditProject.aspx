...
<table cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td class="frmForm">
            <table>
               ...
               <%-- # --%>
                <tr>
                    <td class="frmLabel">Site Address:</td>
                    <td><asp:TextBox ID="txtSiteAddress" runat="server" Width="150"></asp:TextBox></td>
                    <td>&nbsp;</td>
                    <td class="frmLabel">Site Suburb:</td>
                    <td class="frmText"><asp:TextBox ID="txtSiteSuburb" runat="server" Width="150"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="frmLabel">Site State:</td>
                    <td><asp:DropDownList ID="ddlSiteState" runat="server"></asp:DropDownList></td>
                    <td>&nbsp;</td>
                    <td class="frmLabel">Site Postal Code:</td>
                    <td class="frmText"><asp:TextBox ID="txtSitePostalCode" runat="server" Width="150"></asp:TextBox></td>
                </tr>
                <caption>
                    . <%-- 14-01-2023 --%>
                    <tr>
                        <td class="frmLabel">Principal Address:</td>
                        <td>
                            <asp:TextBox ID="txtPrAddress" runat="server" Width="150"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                        <td class="frmLabel">Principal Suburb:</td>
                        <td class="frmText">
                            <asp:TextBox ID="txtPrSuburb" runat="server" Width="150"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="frmLabel">State:</td>
                        <td>
                            <asp:DropDownList ID="ddlPrState" runat="server">
                            </asp:DropDownList>
                        </td>
                        <td>&nbsp;</td>
                        <td class="frmLabel">Postal Code:</td>
                        <td class="frmText">
                            <asp:TextBox ID="txtPrPostalcode" runat="server" Width="150"></asp:TextBox>
                        </td>
                    </tr>
                    <%-- 14-01-2023 --%><%-- San --%>
                    <tr>
                        <td class="frmReqLabel">Account Name:</td>
                        <td>
                            <asp:TextBox ID="TxtAccountName" runat="server" Width="150"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                        <td class="frmReqLabel">BSB:</td>
                        <td>
                            <asp:TextBox ID="TxtBSB" runat="server" Width="150"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="frmReqLabel">Account Number:</td>
                        <td colspan="4">
                            <asp:TextBox ID="TxtAccountNumber" runat="server" Width="150"></asp:TextBox>
                        </td>
                    </tr>
                    <%-- San --%>
                    <tr>
                        ...
                        <td colspan="4">
                            <sos:FileSelect ID="sfsAttachmentsFolder" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td class="frmLabel">Drawings Zoom URL:</td>
                        <td colspan="4">
                            <asp:TextBox ID="txtDeepZoomUrl" runat="server" Width="480"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="frmLabel">Maintenance Manual File:</td>
                        <td colspan="4">
                            <sos:FileSelect ID="sfsMaintenanceManualFile" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td class="frmLabel">Post Project Review File:</td>
                        <td colspan="4">
                            <sos:FileSelect ID="sfsPostProjectReviewFile" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td class="frmLabel" valign="top">Description:</td>
                        <td colspan="4">
                            <asp:TextBox ID="txtDescription" runat="server" Rows="3" TextMode="MultiLine" Width="480"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="frmLabel" valign="top">Special Clause:</td>
                        <td colspan="4">
                            <asp:TextBox ID="txtSpecialClause" runat="server" Rows="6" TextMode="MultiLine" Width="480"></asp:TextBox>
                        </td>
                    </tr>
                    <%-- San --%>
                    <tr>
                        <td class="frmLabel" valign="top">Law of Subcontract: </td>
                        <td colspan="4">
                            <asp:TextBox ID="txtLawofSubcontract" runat="server" Rows="6" TextMode="MultiLine" Width="480"></asp:TextBox>
                        </td>
                    </tr>
                    <%-- San --%>
                    <tr>
                        <td class="frmSubSubTitle" colspan="4">Project Roles</td>
                    </tr>
                    <tr>
                        <td class="frmLabel">Managing Director (MD):</td>
                        <td>
                            <asp:TextBox ID="txtGM" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                        ...
                        <td>
                            <asp:TextBox ID="txtCM" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtPM" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                        ...
                        <td>
                            <asp:TextBox ID="txtDM" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDC" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                        ...
                        <td>
                            <asp:TextBox ID="txtCA" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtForeman" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                        ...
                        <td>
                            <asp:TextBox ID="txtFC" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDA" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                        ...
                        <td>
                            <asp:TextBox ID="txtBA" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtCO" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                        ...
                        <td>
                            <asp:TextBox ID="txtJC" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                    ...
                    <%---------- San ------------%>
                    <tr>
                        <td class="frmLabel">Contracts Administrator (CA3):</td>
                        <td>
                            <asp:TextBox ID="TxtCA3" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                            <asp:HyperLink ID="CmdSelCA3" runat="server" ImageUrl="~/images/IconSearch.gif"></asp:HyperLink>
                            <input id="TxtCA3Id" type="hidden" runat="server" />
                        </td>
                        <td>&nbsp;</td>
                        <td class="frmLabel">Contracts Administrator (CA4):</td>
                        <td>
                            <asp:TextBox ID="TxtCA4" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                            <asp:HyperLink ID="CmdSelCA4" runat="server" ImageUrl="~/images/IconSearch.gif"></asp:HyperLink>
                            <input id="TxtCA4Id" type="hidden" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td class="frmLabel">Contracts Administrator (CA5):</td>
                        <td>
                            <asp:TextBox ID="TxtCA5" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                            <asp:HyperLink ID="CmdSelCA5" runat="server" ImageUrl="~/images/IconSearch.gif"></asp:HyperLink>
                            <input id="TxtCA5Id" type="hidden" runat="server" />
                        </td>
                        <td>&nbsp;</td>
                        <td class="frmLabel">Contracts Administrator (CA6):</td>
                        <td>
                            <asp:TextBox ID="TxtCA6" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="150"></asp:TextBox>
                            <asp:HyperLink ID="CmdSelCA6" runat="server" ImageUrl="~/images/IconSearch.gif"></asp:HyperLink>
                            <input id="TxtCA6Id" type="hidden" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td class="frmSubSubTitle" colspan="4">Second Principal</td>
                    </tr>
                    <tr>
                        <td class="frmLabel">Company:</td>
                        <td>
                            <asp:TextBox ID="txtPrincipal2" runat="server" Width="150"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                        <td class="frmLabel">ABN:</td>
                        <td>
                            <asp:TextBox ID="txtPrincipal2ABN" runat="server" Width="150"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="frmLabel">Contact First Name:</td>
                        <td>
                            <asp:TextBox ID="txtSecondPrincipalFirstName" runat="server" Width="150"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                        <td class="frmLabel">Contact Last Name:</td>
                        <td>
                            <asp:TextBox ID="txtSecondPrincipalLastName" runat="server" Width="150"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="frmLabel">Address:</td>
                        <td>
                            <asp:TextBox ID="txtSecondPrincipalStreet" runat="server" Width="150"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                        <td class="frmLabel">Suburb:</td>
                        <td>
                            <asp:TextBox ID="txtSecondPrincipalLocality" runat="server" Width="150"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="frmLabel">State:</td>
                        <td>
                            <asp:DropDownList ID="ddlSecondPrincipalState" runat="server">
                            </asp:DropDownList>
                        </td>
                        <td>&nbsp;</td>
                        <td class="frmLabel">Postal Code:</td>
                        <td>
                            <asp:TextBox ID="txtSecondPrincipalPostalCode" runat="server" Width="150"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="frmLabel">Email:</td>
                        <td>
                            <asp:TextBox ID="txtSecondPrincipalEmail" runat="server" Width="150"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                        <td class="frmLabel">Phone:</td>
                        <td>
                            <asp:TextBox ID="txtSecondPrincipalPhone" runat="server" Width="150"></asp:TextBox>
                        </td>
                    </tr>
                </caption>
            </table>
    ...
    <tr>
        <td class="frmFormBelow">
               ...
               <%-- San --Hide distribution list--%>

           <table style="display:none;"> <%--San  style="display:none;"--%>
                <tr>
            ...
            <asp:Panel ID="pnlDistributionList" runat="server" CssClass="collapsePanel" Height="0" style="display:none;">   <%--San  style="display:none;"--%>
            <table>
                <tr>
