...
namespace SOS.Web
{
    public partial class ReportActivitySummaryStaffPage : System.Web.UI.Page
    {
        ...
        private void BindReport()
        {
            ...
            foreach (ProjectInfo project in projectInfoList)
            {
                ...
                //#--
                    ...
                    selectedUsers.Add(project.Id.Value, sosFilterSelector.Employees.FindAll(x=>x.IsInactive==false));
                //#--
          ...
          pendingProcessSteps = processController.GetPendingStepsForActivityReport(projectInfoList, selectedUsers, sosFilterSelector.StartDate, sosFilterSelector.EndDate,false);
            ...
            repActivitySummary.LocalReport.ReportPath = Request.PhysicalApplicationPath + "\\Reports\\ActivitySummaryStaff.rdlc";
            ...
            taskTotalList = taskTotalList.OrderBy(x=>x.EmployeeName).ToList(); 
            //#--
