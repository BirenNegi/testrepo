...
<table>
    <tr>
        ...
        <td>&nbsp;&nbsp;</td>
         <%-- # --%>
        <td><asp:HyperLink ID="lnkTenantAccounts" runat="server" CssClass="frmLink">Tenant Variations</asp:HyperLink></td> 
        <td>&nbsp;&nbsp;</td>
         <%-- # --%>
        ...
        <%-- # --%>
        <td>&nbsp;&nbsp;</td>
        <td><asp:HyperLink ID="lnkManageClientAccess" runat="server" CssClass="frmLink">Manage Client Access</asp:HyperLink></td>
        ...
        <td><asp:HyperLink ID="lnkSiteInduction" runat="server" CssClass="frmLink">Site Induction</asp:HyperLink></td>

        <td><asp:HyperLink ID="lnkSiteOrders" runat="server" CssClass="frmLink">Site Orders</asp:HyperLink></td>
         <%-- # --%>
        ...
        <td class="frmForm">
            <table width="100%" cellpadding="3">
                ...
                <tr>
                    ...
                    <td class="frmData"><asp:Label ID="lblSiteaddress" runat="server"></asp:Label></td>
                    <td class="frmInfo">&nbsp;</td>
                    <td class="frmLabel">Site Suburb:</td>
                    <td class="frmData"><asp:Label ID="lblSiteSuburb" runat="server"></asp:Label></td>
                </tr>
                <tr>
                    <td class="frmLabel">Site State:</td>
                    <td class="frmData"><asp:Label ID="lblSiteState" runat="server"></asp:Label></td>
                    <td class="frmInfo">&nbsp;</td>
                    <td class="frmLabel">Site Postal Code:</td>
                    <td class="frmData"><asp:Label ID="lblSitePostalCode" runat="server"></asp:Label></td>
                </tr>

                <%--SAN-- Siteaddress --%>


                  <%--SAN-- Principaladdress --%>
<tr>
    <td class="frmLabel">Principal Address:</td>
    <td class="frmData"><asp:Label ID="lblPrincipaladdress" runat="server"></asp:Label></td>
    <td class="frmInfo">&nbsp;</td>
    <td class="frmLabel">Principal Suburb:</td>
    <td class="frmData"><asp:Label ID="lblPrincipalSuburb" runat="server"></asp:Label></td>
</tr>
<tr>
    <td class="frmLabel"> State:</td>
    <td class="frmData"><asp:Label ID="lblPrincipalState" runat="server"></asp:Label></td>
    <td class="frmInfo">&nbsp;</td>
    <td class="frmLabel"> Postal Code:</td>
    <td class="frmData"><asp:Label ID="lblPrincipalPostalCode" runat="server"></asp:Label></td>
</tr>
  ...
  <%--SAN-- Principaladdress --%>
                ...
                <tr>
                    ...
                    <td class="frmData" colspan="1"><asp:Label ID="lblAttachmentsFolder" runat="server"></asp:Label></td>
                    <%-- San --%>
                     <td class="frmInfo">&nbsp;</td>
                    <td class="frmLabel">Account Name:</td>
                    <td class="frmData"><asp:Label ID="lblAccountName" runat="server"></asp:Label></td>
                ...
                <tr>
                    ...
                    <td class="frmData" colspan="1"><asp:Label ID="lblDeepZoomUrl" runat="server"></asp:Label></td>
                     <%-- San --%>
                     <td class="frmInfo">&nbsp;</td>
                    <td class="frmLabel">BSB:</td>
                    <td class="frmData"><asp:Label ID="lblBSB" runat="server"></asp:Label></td>
                ...
                <tr>
                    ...
                    <td class="frmData" colspan="1"><asp:Label ID="lblMaintenanceManualFile" runat="server"></asp:Label></td>
                     <%-- San --%>
                     <td class="frmInfo">&nbsp;</td>
                    <td class="frmLabel">Account Number:</td>
                    <td class="frmData"><asp:Label ID="lblAccountNumber" runat="server"></asp:Label></td>
                ...
                <tr>
                    ...
                    <td class="frmData" colspan="4"><asp:Label ID="lblLawOfSubcontract" runat="server"></asp:Label></td>
                </tr>
                ...
                <%-- #  DS20230905 Foreman -> Site Manager --%>
                <tr>
                    <td class="frmLabel">Site Manager:</td>
                ...
                <tr>
                    ...
                    <td class="frmInfo">&nbsp;</td>
                    <td class="frmLabel">Contracts Administrator (CA2):</td>
                ...
                <tr>
                    ...
                    <td class="frmData"><asp:HyperLink ID="lnkCA3" runat="server" CssClass="frmLink"></asp:HyperLink></td>
                    <td class="frmInfo">&nbsp;</td>
                    <td class="frmLabel">Contracts Administrator (CA4):</td>
                    <td class="frmData"><asp:HyperLink ID="lnkCA4" runat="server" CssClass="frmLink"></asp:HyperLink></td>
                </tr>
                <tr>
                    <td class="frmLabel">Contracts Administrator (CA5):</td>
                    <td class="frmData"><asp:HyperLink ID="lnkCA5" runat="server" CssClass="frmLink"></asp:HyperLink></td>
                    <td class="frmInfo">&nbsp;</td>
                    <td class="frmLabel">Contracts Administrator (CA6):</td>
                    <td class="frmData"><asp:HyperLink ID="lnkCA6" runat="server" CssClass="frmLink"></asp:HyperLink></td>
                </tr>
    ...
    <tr>
        <td class="frmFormBelow">
            <%-- #--To hide distribution list --%>

            <table style="display:none;">   <%--#--style="display:none;"--%>
                <tr>
                    <td class="frmSubSubTitle">Documents Distribution List</td>
                </tr>
            </table>
            <table cellpadding="3" style="display:none;">     <%--#--style="display:none;"--%>
                <tr>
        ...
        <td>
            <asp:GridView
                ...
                <Columns>
                    ...
                    <%-- #---30/01/2019-- To display only short name
                       
                    <asp:BoundField DataField="SelectedSubContractorName" HeaderText="Subcontractor" HeaderStyle-CssClass="lstHeader" ItemStyle-Wrap="False" 
                        ItemStyle-VerticalAlign="Top"></asp:BoundField>--%>
                        

                    <asp:TemplateField HeaderText="Subcontractor" HeaderStyle-CssClass="lstHeaderTop" ItemStyle-VerticalAlign="Top" >
                         <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("SelectedSubContractorShortName") %>'

                    ToolTip ='<%# Eval("SelectedSubContractorName") %>' ></asp:Label>
                    </ItemTemplate>
                    </asp:TemplateField>
