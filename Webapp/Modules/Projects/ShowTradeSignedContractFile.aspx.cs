...
namespace SOS.Web
{
    public partial class ShowTradeSignedContractFilePage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Utils.SendFile(tradeInfo.Project.AttachmentsFolder, tradeInfo.SignedContractFile);
            }
            catch (Exception Ex)
            {
