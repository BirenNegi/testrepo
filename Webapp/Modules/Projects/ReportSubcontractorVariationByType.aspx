<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" CodeBehind="ReportSubcontractorVariationByType.aspx.cs" Inherits="SOS.Web.ReportSubcontractorVariationByType" %>
...
<sos:TitleBar ID="TitleBar" runat="server" Title="Subcontractor Variations Report By Type" />
            ...
            <table width="100%">
                <tr>
                    ...
                    <td>
                        ...
                         
                      <asp:CheckBox ID="chkAll" Checked="false" AutoPostBack="true" runat="server" OnCheckedChanged="chkAll_CheckedChanged" style="text-align: left" />
