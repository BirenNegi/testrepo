<%@ Page Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" Inherits="SOS.Web.ViewEOTPage" Title="EOT" Codebehind="ViewEOT.aspx.cs" %>
	        ...
	        <table>
	            <tr>
                    ...
                    <td><sos:FileLink ID="sflClientApprovalFile" runat="server" FileTitle="Approval File" /></td>
                        <%-- San --%>
                    <td>&nbsp;&nbsp;</td>
                    <td><sos:FileLink ID="sflClientBackupFile" runat="server" FileTitle="Backup File" /></td>
                        <%-- San --%>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=VC-SQL-02;Initial Catalog=SOS;User ID=SOSApp;Password=V@ugh@ns" ProviderName="System.Data.SqlClient" SelectCommand="SELECT Result + convert(varchar(5),slno)as Result,[EOTID],[NODID] from  (SELECT Row_Number() over(order by Nodid)as Slno, [EOTID],[NODID],'Result'=case when DaysApproved is Null then'NOD' Else 'EOT' End  FROM [NODs_EOTs] WHERE ([EOTId] = @EOTId))A">
        <SelectParameters>
		...
		<td class="frmForm">
			<table>
				...
				<tr>
					...
					<td class="frmData"><asp:Label ID="lblEotType" runat="server"></asp:Label></td>
                    <td>&nbsp;</td>
            ...
            <table>
                 ...
                 <tr>
                    ...
                    <td class="frmData" colspan="4"><asp:Label ID="lblCliecntBackupFile" runat="server"></asp:Label></td>                            
                </tr>
                   <%-- San --%>
                <tr>
