        ...
        <td class="frmForm">
            ...
            <table>
                <tr>
                    ...
                    <td class="frmText" colspan="4"><sos:FileSelect ID="sfsClientApprovalFile" runat="server" /></td>
                </tr>
                <tr>
                    <td class="frmLabel">Cause of delay:</td>
                    <td colspan="4"><asp:TextBox ID="txtCause" runat="server" Width="480"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="frmLabel" valign="top">Nature of delay:</td>
                    <td colspan="4"><asp:TextBox ID="txtNature" runat="server" TextMode="MultiLine" Rows="8" Width="640"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="frmLabel" valign="top">Period of delay:</td>
                    <td colspan="4"><asp:TextBox ID="txtPeriod" runat="server" TextMode="MultiLine" Rows="8" Width="640"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="frmLabel" valign="top">Works affected:</td>
                    <td colspan="4"><asp:TextBox ID="txtWorks" runat="server" TextMode="MultiLine" Rows="4" Width="640"></asp:TextBox></td>
                </tr>
            </table>
        </td>
    </tr>
