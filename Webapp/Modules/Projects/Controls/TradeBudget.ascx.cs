...
#region Members
        ...
        private List<IBudget> approvedprojectBudget;//#---
...
#region Private Methods
        ...
        protected HtmlTableRow EditBudgetRow(TradeBudgetInfo tradeBudget, IBudget budgetProvider, String style)
        {
            ...
            */
            ...
            //#---row.Cells.Add(TextBoxCell(style, "txtBudgetAmountAllowance", "65", tradeBudget.BudgetAmountAllowance, budgetProvider.BudgetUnallocated));//#---
        ...
        private void ReloadForm()
        {
            ...
            //#--
            approvedprojectBudget = ProjectsController.GetInstance().GetProjectBudget(trade.Project, false, false);//---San
...
#region Event Handlers
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (trade != null)
                {
                    ...
                    //#--
                    approvedprojectBudget= projectsController.GetProjectBudget(trade.Project, false, false);//---San
        ...
        protected void valAdd_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            IBudget iBudgetSelected = approvedprojectBudget.Find(pb => pb.BudgetType == budgetProvider.BudgetType && pb.Id == budgetProvider.Id);//#---To validate with only Approved unallocated value
        ...
        public String GetCallbackResult()
        {
            ...
            if (selectedId == null)
            {
               ...
               controlResponse.BudgetSources = new StringDictionary();  
                ...
                projectBudget = projectBudget.OrderBy(a => a.BudgetName).ToList();

                //#--
                if (selectedType == "BOQ")
                {
                    projectBudget = projectBudget.FindAll(x => x.BudgetType == BudgetType.BOQ).ToList();
                    projectBudget.Sort((x, y) => x.BudgetName.CompareTo(y.BudgetName));
                }

                controlResponse.BudgetSources.Clear();
                //#--
            ...
            else   // When a budget source is selected show current balances
            {
              ...
              //#--  controlResponse.Unallocated = UI.Utils.SetFormEditDecimal(iBudgetSelected.BudgetAmountTradeInitial);//#--
