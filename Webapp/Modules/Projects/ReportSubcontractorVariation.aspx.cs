...
namespace SOS.Web
{
    public partial class ReportSubcontractorVariation : System.Web.UI.Page
    {
        ...
        private void BindReport()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                RvSubVar.LocalReport.ReportPath = Request.PhysicalApplicationPath + "Reports\\SubcontractorVariation.rdlc";
                ...
                RvSubVar.LocalReport.DataSources.Add(new ReportDataSource("DataSet1", dt));
                RvSubVar.DataBind();
