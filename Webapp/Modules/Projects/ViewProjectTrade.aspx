                ...
                <td>
                    <asp:GridView 
                        ...
                        <Columns>
                            <asp:TemplateField ItemStyle-VerticalAlign="Top">
                                <ItemTemplate>
                                    <asp:HyperLink runat="server" ImageUrl="~/Images/IconView.gif" NavigateUrl='<%#String.Format("~/Modules/Projects/ViewParticipation.aspx?ParticipationId={0}", Eval("IdStr"))%>' ToolTip="Open"></asp:HyperLink>
                                </ItemTemplate>
                                <ItemStyle VerticalAlign="Top" />
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-VerticalAlign="Top">
                                <ItemTemplate>
                                    <asp:LinkButton Runat="server" CommandArgument="<%#Container.DataItemIndex%>" CommandName="Copy" OnClientClick="return confirm('Copy to active tender invitation list?');"><asp:Image runat="server" AlternateText="Copy to active" ImageUrl="~/Images/IconCopy.png" /></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle VerticalAlign="Top" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderStyle-CssClass="lstHeader" HeaderText="Subcontractor" ItemStyle-VerticalAlign="Top" ItemStyle-Wrap="False">
                                <ItemTemplate>
                                    <span class='<%#StyleNameSelectedParticipation((int?)Eval("Rank"))%>'><%#SOS.UI.Utils.SetFormString((String)Eval("SubcontractorName"))%></span>
                                </ItemTemplate>
                                <HeaderStyle CssClass="lstHeader" />
                                <ItemStyle VerticalAlign="Top" Wrap="False" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderStyle-CssClass="lstHeader" HeaderText="Invitation Date" ItemStyle-VerticalAlign="Top" ItemStyle-Wrap="False">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="lstHeader" HeaderText="Reminder Date" ItemStyle-VerticalAlign="Top" ItemStyle-Wrap="False">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="lstHeader" HeaderText="Quote Date" ItemStyle-VerticalAlign="Top" ItemStyle-Wrap="False">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="lstHeader" HeaderText="Due Date" ItemStyle-VerticalAlign="Top" ItemStyle-Wrap="False">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="lstHeader" HeaderText="Status" ItemStyle-VerticalAlign="Top" ItemStyle-Wrap="False">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="lstHeader" HeaderText="Comparison" ItemStyle-HorizontalAlign="Right" ItemStyle-VerticalAlign="Top" ItemStyle-Wrap="False">
                                <ItemTemplate>
                             ...
                             <asp:TemplateField HeaderStyle-CssClass="lstHeader" HeaderText="Terms" ItemStyle-VerticalAlign="Top" ItemStyle-Wrap="False">
                                <ItemTemplate>
                                    <%#SOS.UI.Utils.SetFormString((String)Eval("PaymentTerms"))%>
                                </ItemTemplate>
                                <HeaderStyle CssClass="lstHeader" />
                                <ItemStyle VerticalAlign="Top" Wrap="False" />
                            </asp:TemplateField>
                           <asp:TemplateField HeaderStyle-CssClass="lstHeader" HeaderText="Rank" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Top" ItemStyle-Wrap="False">
                                <ItemTemplate>
                            ...
                            <asp:BoundField DataField="Comments" HeaderStyle-CssClass="lstHeader" HeaderText="Comments" ItemStyle-VerticalAlign="Top">
                            <HeaderStyle CssClass="lstHeader" />
                            <ItemStyle VerticalAlign="Top" />
                            </asp:BoundField>
...
<!-----#-------To update Subctractor's signed contract file path of ---->
...
<ContentTemplate>
    <table>
        ...
        <tr><td></td></tr>
         ...
         <tr>
            <td class="lstSubTitle" id="tdAPPROVED">
                <asp:Label ID="lblApprovedComparison" runat="server" Text="" Visible="False"></asp:Label></td>
          </tr>
         <%-- #22/11/23 --%>
            ...
            <tr>
                ...
                <asp:PlaceHolder ID="phPreletting" runat="server" Visible="false">
                 ...
                 <asp:PlaceHolder ID="phDraftContract" runat="server" Visible="false">
                    <td>&nbsp;</td>
                    <td><asp:HyperLink ID="lnkDraftContract" runat="server" CssClass="frmLink">Draft Contract</asp:HyperLink></td>
                </asp:PlaceHolder>
                <%-- San --%>
                ...
                <td>
                    ...
                    <asp:GridView 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Subcontractor" HeaderStyle-CssClass="lstHeader" ItemStyle-Wrap="False" ItemStyle-VerticalAlign="Top">
                                <ItemTemplate>
                                    <span class="<%#StyleNameSelectedParticipation((int?)Eval("Rank"))%>">
                                        ...
                                        <%-- #--30-01-2019--To display Short Name  --

                                           <%#SOS.UI.Utils.SetFormString((String)Eval("SubcontractorName"))%> --%>

                                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("SubContractorShortName") %>'
                                     ToolTip ='<%# Eval("SubContractorName") %>' ></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Terms" HeaderStyle-CssClass="lstHeader" ItemStyle-Wrap="False" ItemStyle-VerticalAlign="Top">
                                <ItemTemplate>
                                    <%#SOS.UI.Utils.SetFormString((String)Eval("PaymentTerms"))%>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:BoundField DataField="Comments" HeaderText="Subbies Comments" HeaderStyle-CssClass="lstHeader" ItemStyle-VerticalAlign="Top"></asp:BoundField>
                            <%-- San --%>
                            <asp:BoundField DataField="InternalComments" HeaderStyle-CssClass="lstHeader" HeaderText="Internal Comments" ItemStyle-VerticalAlign="Top">
                            <HeaderStyle CssClass="lstHeader" />
                            <ItemStyle VerticalAlign="Top" />
                            </asp:BoundField>

                            <asp:BoundField DataField="SafetyRisk" HeaderStyle-CssClass="lstHeader" HeaderText="Safety Rating" ItemStyle-VerticalAlign="Top">
                            <HeaderStyle CssClass="lstHeader" />
                            <ItemStyle VerticalAlign="Top" />
                            </asp:BoundField>
