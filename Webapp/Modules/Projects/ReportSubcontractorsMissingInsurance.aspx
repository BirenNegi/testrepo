<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" CodeBehind="ReportSubcontractorsMissingInsurance.aspx.cs" Inherits="SOS.Web.ReportSubcontractorsMissingInsurance" %>
...
<sos:TitleBar ID="TitleBar" runat="server" Title="Missing Insurance links for Subcontractors Report" />
    ...
    <tr>
     ...
     <rsweb:ReportViewer ID="RvSubInsurance" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="711px" Width="90%" PageCountMode="Actual">
     </rsweb:ReportViewer>
