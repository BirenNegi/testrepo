<%@ Page Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" Inherits="SOS.Web.ListClaimsPage" Title="Progress Claims" Codebehind="ListClaims.aspx.cs" %>
        ...
        <td>
            <asp:GridView
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Draft" HeaderStyle-CssClass="lstHeader" ItemStyle-Wrap="False" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Top">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Issue" HeaderStyle-CssClass="lstHeader" ItemStyle-Wrap="False" ItemStyle-HorizontalAlign="Right" ItemStyle-VerticalAlign="Top">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Adj. $" HeaderStyle-CssClass="lstHeader" ItemStyle-Wrap="False" ItemStyle-HorizontalAlign="Right" ItemStyle-VerticalAlign="Top">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-CssClass="lstHeader" ItemStyle-HorizontalAlign="Center" HeaderText="C">
                        <ItemTemplate>
