<%@ Page Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" Inherits="SOS.Web.SearchSiteOrderDetail" Title="Orders" Codebehind="SearchSiteOrderDetail.aspx.cs" %>
            ...
            <asp:GridView
                ...
                <Columns>
                   <asp:TemplateField ItemStyle-VerticalAlign="Top">
                        ...
                        <ItemTemplate>
<asp:HyperLink ImageUrl="~/Images/IconView.gif" ToolTip="Open" runat="server" NavigateUrl='<%#String.Format("~/Modules/SiteOrders/EditSiteOrderDetail.aspx?ProjectId={0}&OrderId={1}&ItemId={2}&OrderTyp={3}", Request.QueryString["ProjectId"].ToString(),Request.QueryString["OrderId"].ToString(), Eval("IdStr"),Request.QueryString["OrderTyp"])%>'></asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
