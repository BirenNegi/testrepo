...
namespace SOS.Web
{
   ...
   public partial class EditSiteOrderHireNS : SOSPage  //System.Web.UI.Page
    {
        private ProjectInfo ProjectInfo = null;
        private SiteOrderInfo SOI = null;
        private PeopleInfo ForemanInfo = null;
        private PeopleInfo ContactInfo = null;
        private PeopleInfo GivenByInfo = null;  // DS20230304
        ...
        //private List<TradeTemplateInfo> tradeTemplates = null; // DS20230321
...
#region Private Methods
        private void BindSearch()
        {
            ...
            ddlState.Items.Add(new ListItem("VIC ", "VIC"));
            ddlState.Items.Add(new ListItem("NSW ", "NSW"));
            ddlState.Items.Add(new ListItem("QLD ", "QLD"));
            ddlState.Items.Add(new ListItem("SA ", "SA"));
            ddlState.Items.Add(new ListItem("WA ", "WA"));
            ddlState.Items.Add(new ListItem("ACT ", "ACT"));
            ddlState.Items.Add(new ListItem("NT ", "NT"));
            ddlState.Items.Add(new ListItem("TAS ", "TAS"));
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (parameterOrderId == null)
            {
                ...
                TitleBar.Title = "Adding Equipment Hire (No Subcontractor)";
            ...
            else
            {
                ...
                TitleBar.Title = "Updating Equipment Hire (No Subcontractor) D" + Int32.Parse(parameterOrderId).ToString("000000");
                cmdUpdateTop.Text = "Save & Exit";
                cmdUpdateBottom.Text = "Save & Exit";
            }
            if (Page.IsPostBack)
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
...

                {
                    ...
                    txtTyp_Desc.Text = "Equipment Hire";
                    ObjectsToForm();
                }
                else
                {
        ...
        private void FormToObjects()
        {
            ...
            // DS20230304 SOI.ContactPhone = txtContactPhone.Text;
            SOI.Name = txtName.Text;
            SOI.Locality = txtLocality.Text;
            SOI.Street = txtStreet.Text;
            SOI.PostalCode = txtPostal.Text;
            SOI.State = ddlState.SelectedValue;
            SOI.ABN = txtABN.Text;
            //
            //
            SOI.Status = "AT";
            SOI.DateStart = sdrDateStart.Date;
            SOI.DateEnd = sdrDateEnd.Date;
            SOI.PaymentStatus = "NEW";
            SOI.PeriodType = "M";
            SOI.ContactPeopleId = 0; // (int)UI.Utils.GetFormInteger(txtContactId.Value);
            SOI.OrderCode = ddlCodeType.SelectedValue;
            SOI.Notes = txtNotes.Text;
            SOI.Comments = txtComments.Text; // DS20230321
            SOI.TypeInfo = txtTypeInfo.Text; // DS20230321
            SOI.TradesCode = txtTradesCode.Value; // DS20230321
            SOI.GivenByPeopleId = (int)UI.Utils.GetFormInteger(txtGivenBy.Value);// DS20230321
            SOI.TradesCode = ddTradesCode.SelectedValue;// DS20230321
        ...
        private void ObjectsToForm()
        {
            ...
            sdrDateStart.Date = SOI.DateStart;
            sdrDateEnd.Date = SOI.DateEnd;
            ...
            ddlState.SelectedValue = SOI.State;
            txtContact.Text = SOI.Contact;
            
            txtEmail.Text = SOI.Email;
            // DS20230304 txtContactPhone.Text = SOI.ContactPhone;
            txtName.Text = SOI.Name;
            txtLocality.Text = SOI.Locality;
            txtStreet.Text = SOI.Street;
            txtPostal.Text = SOI.PostalCode;
            ddlState.SelectedValue = SOI.State;
            txtABN.Text = SOI.ABN;

            txtNotes.Text = SOI.Notes;
            txtComments.Text = SOI.Comments;       // DS20230321
            txtTypeInfo.Text = SOI.TypeInfo;       // DS20230321
            txtTradesCode.Value = SOI.TradesCode; // DS20230321
            txtGivenBy.Value = UI.Utils.SetFormEditInteger(SOI.GivenByPeopleId); // DS20230321
            ddTradesCode.SelectedValue = SOI.TradesCode;// DS20230321
        }
            ...
            protected void cmdUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                //if (txtABN.Text == "") lblMessage.Text += "Please enter ABN!" + "\r\n";
                //if (txtName.Text == "") lblMessage.Text += "Please enter Name!" + "\r\n";
                //if (txtStreet.Text == "") lblMessage.Text += "Please enter Street!" + "\r\n";
                //if (txtLocality.Text == "") lblMessage.Text += "Please enter Suburb!" + "\r\n";
                //if (ddlState.SelectedValue == "") lblMessage.Text += "Please enter State!" + "\r\n";
                //if (txtPostal.Text == "") lblMessage.Text += "Please enter Postal Code!" + "\r\n";
                if (txtABN.Text != "") 
                    {
                     SOS.Library.UI.HttpGetSearch HttpGetSearch  ;
                     HttpGetSearch = new SOS.Library.UI.HttpGetDocumentSearch();
                     string ABNName = HttpGetSearch.AbnSearch(txtABN.Text, "N", "");
                     if (ABNName.Contains("ERROR:"))
                     {
                        lblMessage.Text += ABNName + "\r\n";
                     }
                     else
                     {
                        if (ABNName != txtName.Text) lblMessage.Text += "ABN Name Mismatch: " + ABNName + "\r\n";
                     }
                }
                if (sdrDateStart.Date > sdrDateEnd.Date) { lblMessage.Text += "Start Date may not be after End Date!" + "\r\n"; }
                ...
                if (parameterOrderId == null)
                {
                    ...
                    Response.Redirect("~/Modules/SiteOrders/EditSiteOrderDetailHire.aspx?ProjectId=" + parameterProjectId + "&OrderId=" + parameterOrderId + "&OrderTyp=" + parameterOrderTyp);
                }
                else
                {
