...
namespace SOS.Web
{
    public partial class SearchSiteOrdersAll : SOSPage
    {
        ...
        protected override SiteMapNode BindNavigation(SiteMapResolveEventArgs e)
        {
            ...
            tempNode.ParentNode.Title = "All Site Orders";
...
//lnkbtn.PostBackUrl            //   if (projectInfo.Id == null)
            if (!Page.IsPostBack)
            {
                parameterProjectId = Request.Params["ProjectId"];
            }
            ...
            Session["SiteOrderNav"] = "SearchSiteOrdersAll.aspx";
