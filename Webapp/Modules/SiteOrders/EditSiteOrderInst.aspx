<%@ Page Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" Inherits="SOS.Web.EditSiteOrderInst" Title="Orders" Codebehind="EditSiteOrderInst.aspx.cs" %>
                ...
                <table class="auto-style39">
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td class="auto-style42">
                            <asp:TextBox ID="txtSubContractorName" runat="server" BackColor="#DDDDDD" ReadOnly="True" Width="300px" OnTextChanged="txtSubContractorName_TextChanged"></asp:TextBox>
                            ...
                            <input id="ABN_DB" type="hidden" runat="server" />
                    ...
                    <tr>
                        <td class="auto-styleLHN">ABN:</td>
                        <td class="auto-style42">
                            <asp:TextBox ID="txtABN" runat="server" Height="18px" Width="176px" ReadOnly="True"  BackColor="#DDDDDD"></asp:TextBox>
                        </td>
                        <td class="auto-styleMid"></td>
                    ...
                    <tr>
                        <td class="auto-styleLHN">Site Address:</td>
                        <td class="auto-style42">
                    ...
                    <tr>
                        <td class="auto-styleLHN">Contact:</td>
                        <td class="auto-style42">
                            <asp:TextBox ID="txtContact" runat="server"  BackColor="#DDDDDD" ReadOnly="True" Width="300px"></asp:TextBox>
                            <asp:HyperLink ID="cmdSelContact" runat="server" ImageUrl="~/images/IconSearch.gif" OnClick="PostBack_Click"></asp:HyperLink>
                        </td>
                        <td class="auto-styleMid">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td class="auto-style42">
                            ...
                            <asp:TextBox ID="txtEmail" runat="server" Width="300px" Height="16px"> </asp:TextBox>
                    ...
                    <tr>
                        <td class="auto-styleLHN">Variation Ord:</td>
                        <td class="auto-styleTXT">
                            <asp:TextBox ID="txtVariationId" runat="server" Height="16px" Width="150px"></asp:TextBox>
                        </td>
                        <td class="auto-styleMid"></td>
