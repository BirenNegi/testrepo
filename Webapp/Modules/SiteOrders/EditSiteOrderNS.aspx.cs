...
namespace SOS.Web
{
   ...
   public partial class EditSiteOrderNS : SOSPage  //System.Web.UI.Page
    {
        ...
        //private List<TradeTemplateInfo> tradeTemplates = null; // DS20230307
...
#region Private Methods
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (parameterOrderId == null)
            {
                ...
                TitleBar.Title = "Adding Material Order (No Subcontractor)";
            ...
            else
            {
                ...
                TitleBar.Title = "Updating Material Order (No Subcontractor) D" + Int32.Parse(parameterOrderId).ToString("000000"); //DS20230320
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
...

                {
                    ...
                    txtTyp_Desc.Text = "Material Order";
                    ObjectsToForm();
                }
                else
                {
