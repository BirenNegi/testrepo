<%@ Page Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" Inherits="SOS.Web.ViewSiteOrderPage" Title="Project" Codebehind="ViewSiteOrder.aspx.cs" %>
        ...
        <td>
            <table cellpadding="1" cellspacing="0">
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                  <asp:LinkButton ID="cmdEmail" runat="server" UseSubmitBehavior="true" ToolTip="Email Site Order" OnClientClick="return confirm('Please confirm sending of e-mail and approval of Order?');" onclick="cmdEmailOrder_Click">
        ...
        <td class="frmForm">
           <table class="auto-style39">
                ...
                <tr>
                    ...
                    <td class="auto-styleTXT">
                        <asp:TextBox ID="txtSubContractorAddr" runat="server" BackColor="#DDDDDD" Height="16px" ReadOnly="True" Width="300px"></asp:TextBox>
                    </td>
                    <td class="auto-styleMid"></td>
                    ...
                    <tr>
                     ...
                     <tr>
                       <td class="auto-styleLHL">e-mail:</td>
                        <td class="auto-styleTXT">
                            <asp:TextBox ID="txtEmail" runat="server" Width="300px" Height="16px" BackColor="#DDDDDD" ReadOnly="True" > </asp:TextBox>
                        </td>
                        <td class="auto-styleMid"></td>
                        <td class="auto-styleLHL">SUB-TOTAL</td>
                        <td class="auto-styleTXT">
                            <asp:TextBox ID="txtSubTotal" runat="server" BackColor="#DDDDDD" ReadOnly="True" style="text-align: right" Width="150"></asp:TextBox>
                        </td>
                    </tr>
            ...
            <asp:GridView
                ...
                <Columns>
                   <asp:TemplateField ItemStyle-VerticalAlign="Top">
                        <ItemTemplate>
<asp:HyperLink ImageUrl="~/Images/IconView.gif" ToolTip="Open" runat="server" NavigateUrl='<%#String.Format("~/Modules/SiteOrders/EditSiteOrderDetail.aspx?ProjectId={0}&OrderId={1}&ItemId={2}", Request.QueryString["ProjectId"].ToString(),Request.QueryString["OrderId"].ToString(), Eval("IdStr"))%>'></asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
...
<table>
    <tr>
        <td>
            <table cellpadding="1" cellspacing="1">
                <tr>
 <td><asp:LinkButton ID="btnEditDoc" ToolTip="Goto Document Upload/Delete Screen" runat="server" Visible="True" OnClick="cmdEditDoc_Click"><asp:Image runat="server" AlternateText="Edit" ImageUrl="~/Images/IconEdit.gif" /></asp:LinkButton></td>
...
<%--                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkDetails" runat="server" CommandArgument='<%#String.Format("{0};{1}", Eval("Id"), Eval("DocName")) %>' Text="View Doc" onclick="cmdShowDoc_Click"></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>--%>
                <asp:TemplateField ItemStyle-VerticalAlign="Top">
...
function ConfirmResult()
{
        ...
        document.getElementById("confirmresponse").value = confirm("Confirm Site Order Sent?");
