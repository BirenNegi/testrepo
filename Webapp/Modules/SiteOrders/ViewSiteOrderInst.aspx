<%@ Page Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" Inherits="SOS.Web.ViewSiteOrderPageInst" Title="Project" Codebehind="ViewSiteOrderInst.aspx.cs" %>
...
<table cellpadding="0" cellspacing="0">
  ...
  <%--                   <td><asp:LinkButton ID="cmdEmail1" runat="server" Visible="true" ToolTip="Email Site Order" OnClick="cmdEmailOrder_Click"><asp:Image runat="server" AlternateText="Edit" ImageUrl="~/Images/IconEmail.gif" /></asp:LinkButton></td>--%>
                    <td>
           ...
           <table class="auto-style39">
                ...
                <tr>
                    ...
                    <td class="auto-styleTXT">
                        ...
                        <td class="auto-style41">
                            <asp:DropDownList ID="ddTradesCode" BackColor="#DDDDDD" ReadOnly="True" runat="server" AutoPostBack="false" Width="300px"> </asp:DropDownList>
                ...
                <tr>
                    <td class="auto-styleLHL">Variation Ord:</td>
                    <td class="auto-styleTXT">
                        <asp:TextBox ID="txtVariationId" runat="server" BackColor="#DDDDDD" Height="16px" ReadOnly="True" Width="150"> </asp:TextBox>
                    </td>
                    <td class="auto-styleMid">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <asp:TextBox ID="txtNotes" runat="server" Width="300px" Height="60" TextMode="MultiLine" Rows="5" BackColor="#DDDDDD" ReadOnly="True" ></asp:TextBox>
                             </td>
                        <td class="auto-styleMid">&nbsp;</td>
                        <td class="auto-styleLHL">Comments (Visible Internally):</td>
                        <td class="auto-style41">
                        <asp:TextBox ID="txtComments" runat="server" Width="300px" Height="60" TextMode="MultiLine" Rows="5" BackColor="#DDDDDD" ReadOnly="True" ></asp:TextBox>
                            &nbsp;</td>
                    </tr>
            ...
            <asp:GridView
                ...
                <Columns>
                   <asp:TemplateField ItemStyle-VerticalAlign="Top">
                        <ItemTemplate>
<asp:HyperLink ImageUrl="~/Images/IconView.gif" ToolTip="Open" runat="server" NavigateUrl='<%#String.Format("~/Modules/SiteOrders/SearchSiteOrderDetailInst.aspx?ProjectId={0}&OrderId={1}&ItemId={2}", Request.QueryString["ProjectId"].ToString(),Request.QueryString["OrderId"].ToString(), Eval("IdStr"))%>'></asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
