...
namespace SOS.Web
{
   public partial class EditSiteOrder : SOSPage  //System.Web.UI.Page
    {
        ...
        {
            ddlCodeType.Items.Add(new ListItem("Select Order Type", String.Empty));
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (parameterOrderId == null)
            {
                ...
                TitleBar.Title = "Adding Material Order";
            ...
            else
            {
                ...
                TitleBar.Title = "Updating Material Order D" + Int32.Parse(parameterOrderId).ToString("000000");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (SubContractorInfo != null)
                {
                   ...
                   // txtAtt.Text = SubContractorInfo.Phone;
        ...
        private void FormToObjects()
        {
            ...
            // SOI.DeliveryFee = UI.Utils.GetFormDecimal(txtDeliveryFee.Text);
            //SOI.SubTotal = SOI.ItemsTotal;
            ...
            SOI.PeriodType = "M";
            SOI.VariationID = 0; // (int)UI.Utils.GetFormInteger(variation); ;
            if (txtContactId.Value == "")
            {
                txtContactId.Value = "0";
                txtContact.Text = "";
                SOI.Contact = "";
            }
            ...
            SOI.Comments = txtComments.Text; // DS20230306
            SOI.TypeInfo = txtTypeInfo.Text; // DS20230306
            SOI.TradesCode = txtTradesCode.Value; // DS20230307
            SOI.GivenByPeopleId = (int)UI.Utils.GetFormInteger(txtGivenBy.Value);// DS20230307
            SOI.TradesCode = ddTradesCode.SelectedValue;// DS20230307
        ...
        private void ObjectsToForm()
        {
            ...
            txtComments.Text = SOI.Comments;       // DS20230306
            txtTypeInfo.Text = SOI.TypeInfo;       // DS20230306
            txtTradesCode.Value = SOI.TradesCode ; // DS20230307
            txtGivenBy.Value = UI.Utils.SetFormEditInteger(SOI.GivenByPeopleId); // DS20230307
            ddTradesCode.SelectedValue = SOI.TradesCode;// DS20230307
        }
