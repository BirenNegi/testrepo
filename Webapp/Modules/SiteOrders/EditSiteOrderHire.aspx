<%@ Page Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" Inherits="SOS.Web.EditSiteOrderHire" Title="Orders" Codebehind="EditSiteOrderHire.aspx.cs" %>
                ...
                <table class="auto-style39">
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td class="auto-style42">
                            <asp:TextBox ID="txtABN" runat="server"  BackColor="#DDDDDD" ReadOnly="True" Height="18px" Width="176px"></asp:TextBox>
                        </td>
                        <td class="auto-styleMid"></td>
                    ...
                    <tr>
                        <td class="auto-styleLHN">&nbsp;</td>
                        <td class="auto-style42">&nbsp;</td>
                        <td class="auto-styleMid">&nbsp;</td>
                        <td class="auto-styleLH1">Start Date:</td>
                        <td class="auto-style41">
                            <sos:DateReader ID="sdrDateStart" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="auto-styleMid">&nbsp;</td>
                        <td class="auto-styleLH1">End Date:</td>
                        <td class="auto-style41">
                            <sos:DateReader ID="sdrDateEnd" runat="server" />
                        </td>
                    </tr>
                    <tr>
