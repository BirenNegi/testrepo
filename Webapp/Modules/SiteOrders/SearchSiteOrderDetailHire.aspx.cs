...
namespace SOS.Web
{
    public partial class SearchSiteOrderDetailHire : SOSPage  //System.Web.UI.Page
    {
    ...
    #region Event Handlers
        protected void Page_Init(object sender, EventArgs e)
        {
           ...
           SiteOrderInfo.Items = SiteOrdersController.GetSiteOrderDetails(Int32.Parse(parameterOrderId));
            TitleBar1.Title = "View Equipment Hire Items - " + parameterOrderId;
        }
        ...
        protected void cmdEditItem_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                if (Page.IsValid)
                {
                    Response.Redirect("~/Modules/SiteOrders/EditSiteOrderDetailHire.aspx?ProjectId=" + parameterProjectId + "&OrderId=" + parameterOrderId + "&OrderTyp=" + parameterOrderTyp + "&ItemId=" + ItemId);
                }
            }
        ...
        protected void cmdDeleteItem_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    Response.Redirect("~/Modules/SiteOrders/SearchSiteOrderDetailHire.aspx?ProjectId=" + parameterProjectId + "&OrderId=" + parameterOrderId + "&OrderTyp=" + parameterOrderTyp);
                }
            }
