...
namespace SOS.Web
{
   ...
   public partial class EditSiteOrderHire : SOSPage  //System.Web.UI.Page
    {
...
#region Private Methods
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (parameterOrderId == null)
            {
                ...
                TitleBar.Title = "Adding Equipment Hire Order";
            ...
            else
            {
                ...
                TitleBar.Title = "Updating Equipment Hire Order D" + Int32.Parse(parameterOrderId).ToString("000000");
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (SOI.ItemsTotal != 0)
                {
                    ...
                    txtSubTotal.BackColor = txtContact.BackColor;
                }
                if (!Page.IsPostBack)
