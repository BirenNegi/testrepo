<%@ Page Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" Inherits="SOS.Web.SearchSiteOrderDetailHire" Title="Orders" Codebehind="SearchSiteOrderDetailHire.aspx.cs" %>
            ...
            <asp:GridView
                ...
                <Columns>
                   <asp:TemplateField ItemStyle-VerticalAlign="Top">
                        <ItemTemplate>
<asp:HyperLink ImageUrl="~/Images/IconView.gif" ToolTip="Open" runat="server" NavigateUrl='<%#String.Format("~/Modules/SiteOrders/EditSiteOrderDetailHire.aspx?ProjectId={0}&OrderId={1}&ItemId={2}&OrderTyp={3}", Request.QueryString["ProjectId"].ToString(),Request.QueryString["OrderId"].ToString(), Eval("IdStr"),Request.QueryString["OrderTyp"])%>'></asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:BoundField DataField="Price" HeaderText="Price" DataFormatString="{0:C2}" HeaderStyle-CssClass="lstHeader" ItemStyle-Wrap="False" ItemStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Right"></asp:BoundField>
