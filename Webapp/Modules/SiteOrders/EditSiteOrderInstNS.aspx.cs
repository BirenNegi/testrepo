...
namespace SOS.Web
{
   ...
   public partial class EditSiteOrderInstNS : SOSPage  //System.Web.UI.Page
    {
...
#region Private Methods
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (parameterOrderId == null)
            {
                ...
                TitleBar.Title = "Adding Site Instruction (No Subcontractor)";
            ...
            else
            {
                ...
                TitleBar.Title = "Updating Site Instruction (No Subcontractor)  D" + Int32.Parse(parameterOrderId).ToString("000000");
        ...
        private void FormToObjects()
        {
            ...
            SOI.VariationID = 0;
            //SOI.VariationID = (int)UI.Utils.GetFormInteger(txtv.Value);
        ...
        //private String LoadXMLSettings(XmlTextReader reader)
        //{
