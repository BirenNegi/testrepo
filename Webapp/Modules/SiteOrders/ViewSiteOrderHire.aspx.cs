...
namespace SOS.Web
{
    public partial class ViewSiteOrderPageHire : SOSPage
    {
        ...
        private SiteOrderDetailInfo SiteOrderDetailInfo = null;
        ...
        private PeopleInfo GivenByInfo = null;  // DS20230321
        ...
        private void BindSiteOrder()
        {
            ...
            if (txtTyp_Desc.Text == "Hir") txtTyp_Desc.Text = "Equipment Hire";
            txtOrderDateShow.Text = UI.Utils.SetFormDate(SiteOrderInfo.OrderDate);
            txtOrderDateStartShow.Text = UI.Utils.SetFormDate(SiteOrderInfo.DateStart);
            txtOrderDateEndShow.Text = UI.Utils.SetFormDate(SiteOrderInfo.DateEnd);
            ...
            txtNotes.Text = UI.Utils.SetFormString(SiteOrderInfo.Notes); // DS20230321
            txtComments.Text = UI.Utils.SetFormString(SiteOrderInfo.Comments); // DS20230321
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ContactInfo = PeopleController.GetPersonById(SiteOrderInfo.ContactPeopleId);
                if (SiteOrderInfo.SubContractorId == 0)
                {
                    TitleBar1.Title = "View Equipment Hire (No SubContractor)  D" + Int32.Parse(parameterOrderId).ToString("000000");
                }
                else
                {
                    TitleBar1.Title = "View Equipment Hire D" + Int32.Parse(parameterOrderId).ToString("000000");
                }
                ...
                if (SiteOrderInfo.isOrderApproved == 1 || isReadOnly)
                {
                    // if (SiteOrderInfo.Status == "AT")  { cmdEditTop.Visible = true; } else { cmdEditTop.Visible = false; }
        ...
        protected void cmdEdit_Click(object sender, EventArgs e)
        {
            if (SiteOrderInfo.SubContractorId == 0)
            {
                Response.Redirect($"~/Modules/SiteOrders/EditSiteOrderHireNS.aspx?ProjectId={ProjectInfo.IdStr}&OrderId={SiteOrderInfo.IdStr}&OrderTyp={SiteOrderInfo.Typ}");
            }
            else
            {
                Response.Redirect($"~/Modules/SiteOrders/EditSiteOrderHire.aspx?ProjectId={ProjectInfo.IdStr}&OrderId={SiteOrderInfo.IdStr}&OrderTyp={SiteOrderInfo.Typ}");
            }
        ...
        protected void cmdEditItems_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect($"~/Modules/SiteOrders/EditSiteOrderDetailHire.aspx?ProjectId={ProjectInfo.IdStr}&OrderId={SiteOrderInfo.IdStr}&OrderTyp={SiteOrderInfo.Typ}");
            }
            else
            {
                Response.Redirect($"~/Modules/SiteOrders/SearchSiteOrderDetailHire.aspx?ProjectId={ProjectInfo.IdStr}&OrderId={SiteOrderInfo.IdStr}&OrderTyp={SiteOrderInfo.Typ}");
            }
        }
