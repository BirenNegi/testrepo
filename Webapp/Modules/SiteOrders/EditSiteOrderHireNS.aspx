<%@ Page Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" Inherits="SOS.Web.EditSiteOrderHireNS" Title="Orders" Codebehind="EditSiteOrderHireNS.aspx.cs" %>
            ...
            <td class="auto-style2">
                <table class="auto-style39">
                    ...
                    <tr>
                        ...
                        <td class="auto-style42">
                            <asp:TextBox ID="txtABN" runat="server" Height="18px" Width="176px"></asp:TextBox>
                        </td>
                        <td class="auto-styleMid"></td>
                    ...
                    <tr>
                        <td class="auto-styleLHN">Site Street:</td>
                        <td class="auto-style42">
                    ...
                    <tr>
                        <td class="auto-styleLHN">Site Suburb:</td>
                        <td class="auto-style42">
                    ...
                    <tr>
                        <td class="auto-styleLHN">Site State/Postal:</td>
                        <td class="auto-style42">
