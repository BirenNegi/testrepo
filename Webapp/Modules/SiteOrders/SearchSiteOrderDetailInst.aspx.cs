...
namespace SOS.Web
{
    public partial class SearchSiteOrderDetailInst : SOSPage  //System.Web.UI.Page
    {
    ...
    #region Event Handlers
        ...
        protected void cmdEditItem_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                if (Page.IsValid)
                {
                    Response.Redirect("~/Modules/SiteOrders/EditSiteOrderDetailInst.aspx?ProjectId=" + parameterProjectId + "&OrderId=" + parameterOrderId + "&OrderTyp=" + parameterOrderTyp + "&ItemId=" + ItemId);
                }
            }
        ...
        protected void cmdDeleteItem_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    Response.Redirect("~/Modules/SiteOrders/SearchSiteOrderDetailInst.aspx?ProjectId=" + parameterProjectId + "&OrderId=" + parameterOrderId + "&OrderTyp=" + parameterOrderTyp);
                }
            }
