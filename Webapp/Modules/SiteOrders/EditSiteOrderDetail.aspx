<%@ Page Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" Inherits="SOS.Web.EditSiteOrderDetail" Title="Orders" Codebehind="EditSiteOrderDetail.aspx.cs" %>
    ...
    <table cellpadding="0" cellspacing="0" class="auto-style41">
        <tr>
            <td class="auto-style42">
                ...
                &nbsp;&nbsp;
                <asp:LinkButton ID="cmdCancelTop" runat="server" CausesValidation="False" CssClass="frmButton" UseSubmitBehavior="true" OnClick="cmdCancel_Click">Exit</asp:LinkButton>
                &nbsp;&nbsp;
        ...
        <tr>
            <td class="auto-style42">
                ...
                &nbsp;&nbsp;
                <asp:LinkButton ID="cmdCancelBottom" runat="server" CausesValidation="False" CssClass="frmButton" UseSubmitBehavior="true" OnClick="cmdCancel_Click">Exit</asp:LinkButton>
               &nbsp;&nbsp;
