...
namespace SOS.Web
{
    public partial class EditSiteOrderDetailHire : SOSPage  //System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            TitleBar.Title = "Equipment Hire Item - " + parameterOrderId;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
          ...
          //      phAddNew.Visible = (Security.ViewAccess(Security.userActions.EditSubContractor));
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    //txtTyp_Desc.Text = parameterOrderTyp;
                    ObjectsToForm();
        ...
        protected void SaveItem(object sender, EventArgs e, bool isExit)
        {
            ...
            if (Page.IsValid)
            {
                ...
                if (parameterItemId == null)
                {
                    ...
                    {
                        // 
                        Response.Redirect("~/Modules/SiteOrders/ViewSiteOrderHire.aspx?OrderId=" + parameterOrderId + "&ProjectId=" + parameterProjectId + "&OrderTyp=" + parameterOrderTyp);
                    }
                    else
                    {
                        Response.Redirect("~/Modules/SiteOrders/EditSiteOrderDetailHire.aspx?OrderId=" + parameterOrderId + "&ProjectId=" + parameterProjectId + "&OrderTyp=" + parameterOrderTyp);
                    }
                }
                else
                {
                    ...
                    //  DS20221122  Response.Redirect("~/Modules/SiteOrders/SearchSiteOrderDetailHire.aspx?OrderId=" + parameterOrderId + "&ProjectId=" + parameterProjectId + "&OrderTyp=" + parameterOrderTyp);
                    Response.Redirect("~/Modules/SiteOrders/ViewSiteOrderHire.aspx?OrderId=" + parameterOrderId + "&ProjectId=" + parameterProjectId + "&OrderTyp=" + parameterOrderTyp);
                }
            }
        }
