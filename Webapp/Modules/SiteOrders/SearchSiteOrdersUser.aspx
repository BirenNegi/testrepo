<%@ Page Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" Inherits="SOS.Web.SearchSiteOrdersUser" Title="Orders" Codebehind="SearchSiteOrdersUser.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">

<sos:TitleBar ID="TitleBar1" runat="server" Title="View My Site Orders" />
...
<asp:ObjectDataSource
    ...
    SelectMethod="SearchSiteOrdersUser"  
    SelectCountMethod="SearchSiteOrdersUserCount"
                ...
                <Columns>
                  ...
                  <asp:TemplateField ItemStyle-VerticalAlign="Top">
                    <HeaderStyle CssClass="lstHeader"></HeaderStyle>
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkDetails" runat="server" ToolTip="Download Order + ALL documents for this order" CausesValidation="true" CommandArgument='<%#String.Format("{0}", Eval("Id")) %>' onclick="cmdPrintOrder_Click">
