...
namespace SOS.Web
{
    public partial class ViewSiteOrderPage : SOSPage
    {
        ...
        private void BindSiteOrder()
        {
            ...
            if (txtTyp_Desc.Text == "Mat") txtTyp_Desc.Text = "Material Order";
            ...
            txtComments.Text = UI.Utils.SetFormString(SiteOrderInfo.Comments); // DS20230308
        ...
        {
            string parameterReadOnly = Request.Params["ReadOnly"];
            if (parameterReadOnly != null)   // DS20230629
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int UserId = (int)Web.Utils.GetCurrentUserId(); //DS20230629
            try
            {
                ...
                //tradeTemplates = TradesController.GetInstance().GetTradeTemplatesFromCode(SiteOrderInfo.TradesCode);
                ...
                {
                    TitleBar1.Title = "View Material Order (No SubContractor) D" + Int32.Parse(parameterOrderId).ToString("000000");
                }
                else
                {
                    TitleBar1.Title = "View Material Order D" + Int32.Parse(parameterOrderId).ToString("000000");
                ...
                //{
                //    if (SOA.Process == "DOS" & SOA.Status == "A") { isReadOnly = true; cmdEditTop.Enabled = false; }  //DS20231128
                //}
                ...
                {
                    txtContact.Text = SiteOrderInfo.Contact;
                    txtEmail.Text = SiteOrderInfo.Email;
                    // DS20230304  txtAtt.Text = SiteOrderInfo.ContactPhone;
                }
        ...
        protected void cmdEdit_Click(object sender, EventArgs e)
        {
            if (SiteOrderInfo.SubContractorId == 0)
            {
                Response.Redirect($"~/Modules/SiteOrders/EditSiteOrderNS.aspx?ProjectId={ProjectInfo.IdStr}&OrderId={SiteOrderInfo.IdStr}&OrderTyp={SiteOrderInfo.Typ}");

            }
            else
            {
                Response.Redirect($"~/Modules/SiteOrders/EditSiteOrder.aspx?ProjectId={ProjectInfo.IdStr}&OrderId={SiteOrderInfo.IdStr}&OrderTyp={SiteOrderInfo.Typ}");
        ...
        protected void cmdEditItems_Click(object sender, EventArgs e)
        {
            ...
            if (parameterReadOnly == null)
            {
                ...
                {
                    Response.Redirect($"~/Modules/SiteOrders/EditSiteOrderDetail.aspx?ProjectId={ProjectInfo.IdStr}&OrderId={SiteOrderInfo.IdStr}&OrderTyp={SiteOrderInfo.Typ}");
                }
                else
                {
                    Response.Redirect($"~/Modules/SiteOrders/SearchSiteOrderDetail.aspx?ProjectId={ProjectInfo.IdStr}&OrderId={SiteOrderInfo.IdStr}&OrderTyp={SiteOrderInfo.Typ}");
                }
            }
        }
        ...
        protected void cmdEmailOrder_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SendAddress = SiteOrdersController.SendSubmisionNotification(SiteOrderInfo.IdStr, (int)Web.Utils.GetCurrentUserId());  //DS20231010
            }
            catch (Exception Ex)
            {
                Utils.ProcessPageLoadException(this, Ex);
