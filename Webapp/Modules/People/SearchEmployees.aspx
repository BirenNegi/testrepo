<%@ Page Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" Inherits="SOS.Web.SearchEmployeesPage" Title="Employees" Codebehind="SearchEmployees.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">

<sos:TitleBar ID="TitleBar1" runat="server" Title="Staff" />
...
<asp:ObjectDataSource 
    ...
    EnablePaging="true">
    <SelectParameters>
        <asp:Parameter Name="peopleType" DefaultValue="EM" /> 
        ...
        <td>
            <table cellspacing="1" cellpadding="1">
                <tr>
                    ...
                    <td><asp:HyperLink ID="lnkAddNew" runat="server" ImageUrl="~/Images/IconAdd.gif" ToolTip="Add New" NavigateUrl="~/Modules/People/EditEmployee.aspx"></asp:HyperLink> </td>
                    <td>&nbsp;&nbsp;</td>
                    </asp:PlaceHolder>
            ...
            <asp:GridView 
                ...
                <Columns>
                    <asp:TemplateField ItemStyle-VerticalAlign="Top">
                        <ItemTemplate>
                            <asp:HyperLink ImageUrl="~/Images/IconView.gif" ToolTip="Open" runat="server" NavigateUrl='<%#String.Format("~/Modules/People/ViewEmployee.aspx?peopleId={0}", Eval("IdStr"))%>'></asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Last Login" SortExpression="LastLogin" Visible="false" HeaderStyle-CssClass="lstHeader" ItemStyle-VerticalAlign="Top" ItemStyle-Wrap="false">
                        <ItemTemplate>
