...
<%@ Page Language="C#" AutoEventWireup="true" Inherits="SOS.Web.SelectClientContactSub" Title="Contact" Codebehind="SelectClientContactSub.aspx.cs" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Select Client Contact</title>
...
<body onbeforeunload="refreshAndClose();">
    ...
    <asp:ObjectDataSource 
        ...
        SelectMethod="SearchPeopleSub" 
        SelectCountMethod="SearchPeopleCountSub"    
        SortParameterName="orderBy"
        EnablePaging="true">
        <SelectParameters>
            <asp:Parameter Name="peopleType" DefaultValue="CL" /> 
            <asp:ControlParameter Name="strSearch" ControlID="txtSearch" />
            <asp:ControlParameter Name="strSubContractorId" ControlID="txtSubContractorId" />
            ...
            <td>
                <table cellspacing="1" cellpadding="1">
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td><asp:Button ID="cmdSearch" runat="server" Text="Search" OnClick="cmdSearch_Click"></asp:Button><asp:TextBox ID="txtSubContractorId" runat="server"></asp:TextBox></td>
                        <td>&nbsp;&nbsp;</td>
                        <td class="frmText"></td>
                        <td><asp:DropDownList ID="ddlBusinessUnit" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlBusinessUnit_SelectedIndexChanged" Visible="false"></asp:DropDownList></td>
                        <td>&nbsp;&nbsp;</td>
                ...
                <asp:GridView 
                    ...
                    <Columns>
                        <asp:TemplateField HeaderStyle-CssClass="lstHeader" ItemStyle-CssClass="lstLink">
                            <ItemTemplate>
                                <asp:HyperLink ID="lnkSelect" runat="server" NavigateUrl='<%#SOS.Web.Utils.PopupSendPeopleSub((System.Web.UI.Page)this.Page, (String)Eval("IdStr"), (String)Eval("Name"))%>' Text="Select"></asp:HyperLink>
                            </ItemTemplate>
                        </asp:TemplateField>
                 ...
                 <%--      <asp:BoundField DataField="CompanyName" SortExpression="CompanyName" HeaderText="Company" HeaderStyle-CssClass="lstHeader" ItemStyle-Wrap="False" ItemStyle-VerticalAlign="Top"></asp:BoundField>--%>
                        ...
                        <asp:BoundField DataField="State" HeaderText="State" HeaderStyle-CssClass="lstHeader" ItemStyle-Wrap="False" ItemStyle-VerticalAlign="Top"></asp:BoundField>
                         <asp:BoundField DataField="Email" HeaderText="Email" HeaderStyle-CssClass="lstHeader" ItemStyle-Wrap="False" ItemStyle-VerticalAlign="Top"></asp:BoundField>
