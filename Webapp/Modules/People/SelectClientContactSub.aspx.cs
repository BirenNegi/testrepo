...
namespace SOS.Web
{
    public partial class SelectClientContactSub : System.Web.UI.Page
    {
        #region Members
        private BusinessUnitInfo businessUnitInfo = null;
        private String parameterSubContractorId = "";
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            String parameterBusinessUnitId = null;//Request.Params["BusinessUnitId"];
             parameterSubContractorId = Request.Params["SubContractorId"];
            txtSubContractorId.Text = parameterSubContractorId;
            txtSubContractorId.Visible = false;
          //  gvPeople.Columns[5].Visible = false;
            gvPeople.Columns[6].Visible = false;
            try
            {
