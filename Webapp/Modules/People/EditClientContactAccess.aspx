...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        //To allow to select only one chkbox of type Attention 
         ...
         {
             //alert("1");
             document.getElementById("SyncIMG").style.visibility = "visible";

         }
         function HideSync() {
            // alert("2");
             document.getElementById('SyncIMG').style.visibility = "hidden";
         }
    ...
    <table id="AddClientsContact" ><%--style="display:none;"--%>
            ...
            <tr>
                <td class="frmTopBox">
                    ...
                    <asp:linkbutton id="cmdCancelTop" CssClass="frmButton" runat="server" CausesValidation="False" OnClick="cmdCancel_Click">Cancel</asp:linkbutton> &nbsp;&nbsp 
            ...
            <tr>
                ...
                <td class="frmForm" valign="top" style="padding-left:20px;" >

                    <table>
                        <tr>
                            <td colspan="2" class="frmText">
                                To Add Existing Client to Project</td>
                        ...
                        <tr>
                            ...
                            <td class="frmLabel">  
                                 <asp:TextBox ID="txtClientName" runat="server" ReadOnly="true"></asp:TextBox>
                                 <asp:HyperLink id="hplExistingClient" CssClass="frmButton" runat="server" CausesValidation="False" ImageUrl="~/images/IconSearch.gif" ></asp:HyperLink> 
                                 <input id="txtClientId" type="hidden" runat="server" />
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td> <asp:linkbutton id="cmdExistingSave" CssClass="frmButton" runat="server" OnClick="cmdExisting_Click" CausesValidation="false">Save</asp:linkbutton></td>
                ...
                <td class="frmForm" valign="top" style="padding-left:20px;" >
                     <table>
                            <tr>
                                <td colspan="2" class="frmText">
                                    To Sync Phots to Client Portal</td>
                            ...
                            <tr>
                                ...
                                <td class="frmLabel">  
                                     <asp:TextBox ID="TxtPath" runat="server" ReadOnly="true" Width="473px"></asp:TextBox>
                                     <%--<asp:HyperLink id="HyperLink1" CssClass="frmButton" runat="server" CausesValidation="False" ImageUrl="~/images/IconSearch.gif"  Enabled="false"></asp:HyperLink> 
                            ...
                            <tr>
                                <td></td>
                                <td class="frmText"><asp:label ID="lblpath" runat="server" Visible="false" ForeColor="#ff0000"></asp:label></td>

                            </tr>
                            <tr>
                            <td>&nbsp;</td>
                            <td> <asp:linkbutton id="Linkbutton1" CssClass="frmButton" runat="server"  OnClick="BtnSync_Click" CausesValidation="false">Sync</asp:linkbutton></td>

                        </tr>
                            <tr>
                            <td>&nbsp;</td>
                            <td valign="top"> 
                               <div id="SyncIMG" class="lstTitle" style="float:left;visibility: hidden; height:100px;width:180px;color:crimson;">
                                <img alt="12" src="/Images/Sync11.gif" style="height:100px;width:180px;"/>Syncing... 
                                </div>
                                <br />
...
<table cellspacing="0" cellpadding="0" >
        ...
        <tr>
            ...
            <td>&nbsp; &nbsp;</td>
            <td class="lstTitle" style="text-align:right; padding-right:80px;background-color:gainsboro; ">Website Access</td><%--display:none--%>
             <td>&nbsp; &nbsp;</td>
            <td class="lstTitle" style="text-align:right; padding-right:10px;background-color:gainsboro; ">Project Images</td>

        </tr>

        <tr>
            <%--Distributionlist--%>
                <td class="frmBottomBox" valign="top">
        ...
        <HeaderStyle CssClass="lstHeader"></HeaderStyle>
                            ...
                            <asp:TemplateField HeaderText="Manage Website&lt;br/&gt; Access Account" HeaderStyle-CssClass="lstHeader" Visible="True">
                                  <ItemTemplate>
...
<HeaderStyle CssClass="lstHeader"></HeaderStyle>
                    ...
                    <asp:BoundField DataField="UserPassword" HeaderText="Password" SortExpression="UserLogin" HeaderStyle-CssClass="lstHeader" >
<HeaderStyle CssClass="lstHeader"></HeaderStyle>
                    </asp:BoundField>
...
<RowStyle CssClass="lstItem"></RowStyle>
            ...
            <td>&nbsp; &nbsp;</td>
                <td class="frmBottomBox" style="vertical-align:top">
                    <asp:TreeView ID="TreeView1" runat="server"  ForeColor="#000066">
