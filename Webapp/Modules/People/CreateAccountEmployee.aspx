<%@ Page Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" Inherits="SOS.Web.CreateAccountEmployeePage" Title="Employee Account" Codebehind="CreateAccountEmployee.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">

<sos:TitleBar ID="TitleBar" runat="server" Title="Staff Member - Creating Access Account" />
    ...
    <tr>
        <td class="frmForm">
            <table width="100%">
                ...
                <tr>
                    <td class="frmLabel">Signature File:</td>
                    <td class="frmText"><asp:TextBox ID="txtSignature" runat="server" Width="150"></asp:TextBox></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
