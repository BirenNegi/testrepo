...
<body>
    <form id="form1" runat="server">
       ...
       <%-- <tr>
        ...
        <tr>
            <td> 
                <div style="height:265px;overflow:scroll;padding-left:10px;">
...
<%--                <asp:Button runat="server" ID="Button2"  Text="Cancel" onclick="window.close();"/>--%>
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:SOSTestConnectionString %>" SelectCommand="SELECT DISTINCT 
...
WHERE        (dbo.Trades.ProjectId =@ProjectId) AND (dbo.TradeParticipations.Rank = 1)
