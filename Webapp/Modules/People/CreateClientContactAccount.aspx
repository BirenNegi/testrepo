<%@ Page Title=" Create Client Contact Account" Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" CodeBehind="CreateClientContactAccount.aspx.cs" Inherits="SOS.Web.CreateClientContactAccount" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <sos:TitleBar ID="TitleBar" runat="server" Title="Client Contact - Creating Access Account" />
